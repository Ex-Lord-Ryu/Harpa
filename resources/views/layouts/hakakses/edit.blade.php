        ...
        <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('hakakses.update', $hakakses->id) }}" method="POST" onsubmit="confirmUpdate(event)">
                        @csrf
                        @method('PUT')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            @if(session('otp_sent'))
                                ...
                                <form action="{{ route('hakakses.verify-otp', $hakakses->id) }}" method="POST" class="mb-3">
                                    @csrf
                            ...
                            @else
                                <form action="{{ route('hakakses.send-otp', $hakakses->id) }}" method="POST" onsubmit="confirmResetPassword(event)">
                                    @csrf
                    ...
                    <form action="{{ route('hakakses.update-password', $hakakses->id) }}" method="POST" onsubmit="confirmUpdate(event)">
                        @csrf
                        @method('PUT')
                        <div class="form-group row mb-4">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                ...
                                <a href="{{ route('hakakses.index') }}" class="btn btn-secondary ml-2">
